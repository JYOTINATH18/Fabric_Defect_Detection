...
# Load the dataset
data_path = "D:\\FabricDataset\\Data Set"
...
# Create a dictionary to map the target classes to numerical labels
class_to_label = {defect_types[i]: i for i in range(num_classes)}
...
for i, defect_type in enumerate(defect_types):
    ...
    for img_path in os.listdir(class_path):
        ...
        X.append(img)
        y.append(class_to_label[defect_type])
